...
export function UploadEvidenceForm({ jobId, jobStatus }: { jobId: string, jobStatus: string }) {
    ...
    const saveOffline = (file: File) => {
        ...
        toast("Sin conexión. La foto se ha guardado (simulado) para subir después.", {
        ...
        <Card className="border-dashed border-2 bg-gray-50">
            <CardContent className="pt-6 flex flex-col items-center gap-4">
                ...
                <div className="w-full">
                    <Label htmlFor="photo-upload" className="sr-only">Subir Foto</Label>
                    {!localPreview && (
                        <Input
                            id="photo-upload"
                            type="file"
